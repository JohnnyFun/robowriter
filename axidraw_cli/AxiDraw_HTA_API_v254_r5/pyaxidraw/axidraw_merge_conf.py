...
#
# Version 2.5.3, dated 2019-06-11
#
...
speed_lim_xy_lr = 12.000    # Maximum XY speed allowed when in Low Resolution mode, in inches per second.  Default: 12.000 Max: 17.3958
...
const_speed_factor_lr = 0.5  # When in constant-speed mode, multiply the pen-down speed by this factor. Default: 0.5 for Low Res mode
const_speed_factor_hr = 0.4  # When in constant-speed mode, multiply the pen-down speed by this factor. Default: 0.3 for Hi Res mode

start_pos_x = 0              # Parking position, in pixels. Default: 0
start_pos_y = 0              # Parking position, in pixels. Default: 0
...
bounds_tolerance = 0.001    # Allow movements outside of declared bounds by this distance, in inches.
